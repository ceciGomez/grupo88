                        ...
                        <div class="col-md-3">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h4 class="box-title">Arrastrar Eventos</h4>
                                </div>
                                <div class="box-body">
                                    <!-- the events -->
                                    <div id='external-events'>                                        
                                        <div class='external-event bg-green'>Almuerzo</div>
                                        <div class='external-event bg-red'>Recoger Frascos</div>
                                        <div class='external-event bg-aqua'>Realizar Pasteurizacion</div>
                                        <div class='external-event bg-yellow'>Registrar Cultivos</div>
                                        <div class='external-event bg-navy'>Recoger Resultados de Serologia</div>
                                        <p>
                                            <input type='checkbox' id='drop-remove' /> <label for='drop-remove'>quitar despues de añadidos</label>
                                        </p>
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /. box -->
