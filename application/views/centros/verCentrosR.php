                          ...
                          <tr>
                            ...
                            <td colspan="" rowspan="" headers="">
                              <a href="<?php echo base_url()?>index.php/centrosRec/view/verUnCentroR/<?php echo $value->idCentroRecoleccion?>"
                                class="btn btn-default btn-sm" role="button" title="Ver un Centro de Recolección">
                                <i class="fa fa-eye"></i></a>
                                 <a href="<?php echo base_url()?>index.php/centrosRec/view/editarCentroR/<?php echo $value->idCentroRecoleccion?>"
                                  class="btn btn-default btn-sm" role="button" title="Editar Centro de Recolección">
                                <i class="fa fa-pencil"></i></a>
                                <a href="<?php echo base_url(); ?>index.php/centrosRec/view/eliminarCentro/<?php echo $value->idCentroRecoleccion?>" title="Eliminar Centro de Recolección" 
