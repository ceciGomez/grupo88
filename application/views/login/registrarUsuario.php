            ...
            <div class="col-md-6 col-md-offset-2">
               <div class="panel panel-default">
                  <div class="panel-body">
                     <form data-toggle="validator" class="form-horizontal" role="form" action="<?php echo base_url() ?>index.php/clogin/altaUsuario" method="post" name="formRegistrarUs" id="formRegistrarUsuario" accept-charset="utf-8">
                        <div class="row">
                           <div class="col-md-6">
                              <label >Nombre</label>
                           ...
                           <div class="col-md-6">
                              <label >Email</label>
                              <input type="mail" id="mail" class="form-control" placeholder="Escriba el Nombre aqui" name="mail"/>
                           </div>
                           <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                              ...
                              <input type="password" id="pass2" class="form-control" placeholder="Escriba contraseña aqui" name="pass2" required/>
                              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                              <span class="help-block with-errors">* Campo Requerido</span>
                           </div>
                           <div class="col-md-6">
