...
<aside class="right-side">
   ...
   <section class="content" id="cont">
      <h4> <font color="red">
         DEBE REGISTRAR PREVIAMENTE MADRE DONANTE</font>
      </h4>
      <div class="row">
         ...
         <div class="container">
            ...
            <div class="row content">
               <div class="col-xs-2">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input  disabled="" type="text" class="form-control" id="fechaDesde"
               ...
               <div class="col-xs-2">
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input disabled="" type="text" class="form-control" id="fechaHasta"
               ...
               <div class="col-lg-2">
                  ...
                  <input disabled="" name="IdiaVisita" id="diaVisita" type="text" class="form-control" placeholder="Lunes">
               </div>
               <!-- /. pedido de serologia -->
               ...
               <div>
                  <div class="radio">
                     <label>
                     <input disabled="" type="radio" name="IpedidoSerologia" id="pedidoSerologia" value="1" checked>
                     Si
                     </label>
                     <label>
                     <input disabled="" type="radio" name="IpedidoSerologia" id="pedidoSerologia" value="0">
                     No
                     </label>
                  </div>
               </div>
            ...
            <div class="row content"  >
               ...
               <div class="col-lg-1">
                  <label>Número</label>
                  <input disabled="" name="Inumero" id="numero" type="text" class="form-control" placeholder="">
               </div>
               <div class="col-lg-2">
                  <label>Barrio</label>
                  <input disabled="" name="Ibarrio" id="barrio" type="text" class="form-control" placeholder="">
               </div>
               <div class="col-lg-1">
                  <label>Piso</label>
                  <input disabled="" name="Ipiso" id="piso" type="text" class="form-control" placeholder="">
               </div>
               <div class="col-lg-1">
                  <label>Dpto.</label>
                  <input disabled="" name="Idpto" id="dpto" type="text" class="form-control" placeholder="">
               </div>
               <div class="col-lg-1">
                  <label>Mz.</label>
                  <input disabled="" name="Imz" id="mz" type="text" class="form-control" placeholder="">
               </div>
               <div class="col-lg-1">
                  <label>Pc.</label>
                  <input disabled="" name="Ipc" id="pc" type="text" class="form-control" placeholder="">
               </div>
            </div>
            <br>
            ...
            <div>
               <div class="row">
                  <div class="col-xs-3">
                     ...
                     <div class="form-group">
                        <label>Zona</label>
                        <div>
                           <select  disabled="" name="Izona" id="zona" value="$valor" class="form-control">
               ...
               <div>
                  <div class="radio">
                     <label>
                     <input disabled="" type="radio" name="IpermiteFoto" id="permiteFoto" value="1" checked>
                     Si
                     </label>
                     <label>
                     <input disabled="" type="radio" name="IpermiteFoto" id="permiteFoto" value="0"checked>
                     No
                     </label>
                  </div>
               </div>
            ...
            <div class="pull-left">
               <div class="form-group">
                  <button disabled="" data-target="#compose-modal"  data-toggle="modal" aria-hidden="true" 
                     id="guardaConsentimiento" class="btn btn-success btn-md">Guardar</button>
                  <button disabled="" class="btn btn-danger btn-md">Cancelar</button>
               </div>
            </div>
         </div>
      </div>
