   ...
   <section class="content" id="cont">
      <div class="row">
         ...
         <div class="pull-right content">
            <div class="form-group">
               <a  aria-hidden="true" href="<?php echo base_url()?>index.php/cseguimiento/view/seguimientosUnBa/<?php echo $unSeguimientoBa[0]->BebeAsociado_idBebeAsociado;?>"class="btn btn-primary btn-md">volver</a>
            </div>
         </div>
